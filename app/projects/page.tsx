    ...
    <div className="mx-auto flex max-w-7xl flex-col gap-10 px-4 py-14 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col gap-8">
        {projects.map((project, index) => (
          <article key={project.slug} className="relative flex flex-col gap-8 p-6 sm:p-8 lg:flex-row lg:items-center">
            {index > 0 && (
              <div className="absolute inset-x-0 top-0 h-px w-full bg-white/[0.06]" />
            )}
